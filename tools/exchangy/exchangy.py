...
# - latest; micro fix in networking function (was failing in rare cases)     #
# ...                                                                        #
...
xchConfirmed = False
foundMultiple = False
exchangyVersion = 'v1.04' # REMINDER: !!!
...
def owax():
  ...
  # covering both and leave owa as main (accepting 2 -3 more requests per target), since the tool was initially build on owa based detection.
  version = None
