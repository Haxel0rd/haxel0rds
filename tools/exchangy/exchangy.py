...
xchConfirmed = False
foundMultiple = False
exchangyVersion = 'v1.03' # REMINDER: !!!
...
def owax():
  ...
  for path in paths:
    packet = owa_packet.replace('/owa/auth/logon.aspx','https://'+str(target)+'/'+str(path)+'/')
