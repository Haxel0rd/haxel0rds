...
# - Requires OWA to run at target (fetching buildnumber from there           #
#   build number with numbers from MSdocs. Does not detect KB patches!       #
# - Supported Patchlevels are:                                               #
#   ServicePack (SP), CumulativeUpdates (CU) and RollupUpdates (RU).         #
# - Can even deal with customized and "cleansed" owa panels                  #
